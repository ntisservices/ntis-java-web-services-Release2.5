<html>
	...
	Once deployed you could invoke the WSDL from  <i><b><a href="http://localhost:8880/SubscriberService/services/subscriber.wsdl">http://localhost:8880/SubscriberService/services/subscriber.wsdl</a></b></i></p>
	...
	It will build and deploy the SubscriberService.war on jetty and the wsdl could be accessed from <i><b><a href="http://localhost:8880/SubscriberService/services/subscriber.wsdl">http://localhost:8880/SubscriberService/services/subscriber.wsdl</a></b></i></p>
	...
	and the script will build and deploy the SubscriberService.war file on Tomcat and the wsdl could be accessed from <i><b><a href="http://localhost:8880/SubscriberService/services/subscriber.wsdl">http://localhost:8880/SubscriberService/services/subscriber.wsdl</a></b></i></p>
</html>
